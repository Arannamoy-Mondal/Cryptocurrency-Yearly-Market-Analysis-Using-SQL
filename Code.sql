...
WITH TMP AS (SELECT SYMBOL,(MAX_PRICE-MIN_PRICE)*100/MIN_PRICE AS MAX_RETURN FROM CRYPTO ORDER BY CIRCULATING_SUPPLY DESC)
SELECT TMP.SYMBOL,TMP.MAX_RETURN FROM TMP WHERE SYMBOL='BTC';
